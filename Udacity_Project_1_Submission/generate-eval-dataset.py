...
def customer_text(text: str) -> str:
    """Remove private reasoning blocks from customer/evaluator-visible text."""
...
def invoke_harness_once(
    ...
    response = rt.invoke_harness(
        ...
        # Scope managed memory to this one test case. Without actorId, the
        # default managed-memory actor can retrieve facts from other tests.
        actorId=session_id,
    ...
    return {"final_output_text": customer_text(texts[-1]) if texts else ""}
