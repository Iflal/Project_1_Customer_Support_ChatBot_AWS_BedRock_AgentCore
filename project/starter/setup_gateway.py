...
TOOL_SCHEMA = {
    ...
    "description": (
        ...
        "Call this only after the customer explicitly provided a bug description, "
        "their own steps to reproduce it, and their environment in this conversation. "
        "Never infer a value or send Unknown, N/A, unspecified, or other placeholders. "
    ...
    "inputSchema": {
        ...
        "properties": {
            "description": {
                "type": "string",
                "description": "What is broken, explicitly stated in the customer's words. Never infer it or use a placeholder.",
            },
            "stepsToReproduce": {
                "type": "string",
                "description": "Actions the customer explicitly said they performed, in order. Never derive steps from the FAQ or bug description.",
            },
            "environment": {
                "type": "string",
                "description": "Environment explicitly provided by the customer: browser, OS, and/or device. Never send Unknown or another placeholder.",
            },
        },
